...
for kv in "net.core.default_qdisc=fq" "net.ipv4.tcp_congestion_control=bbr" \
          "net.core.somaxconn=4096" "net.ipv4.tcp_slow_start_after_idle=0"; do
    key="${kv%%=*}"
...
echo "      ✅ BBR: $(sysctl -n net.ipv4.tcp_congestion_control 2>/dev/null) / qdisc $(sysctl -n net.core.default_qdisc 2>/dev/null) / somaxconn $(sysctl -n net.core.somaxconn 2>/dev/null)"
